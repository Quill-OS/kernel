...
$GITDIR/scripts/build_kernel.sh n905b std
$GITDIR/scripts/build_kernel.sh n905b root
$GITDIR/scripts/build_kernel.sh n905b diags
...
$GITDIR/scripts/build_kernel.sh n613 std
$GITDIR/scripts/build_kernel.sh n613 root
$GITDIR/scripts/build_kernel.sh n613 diags
