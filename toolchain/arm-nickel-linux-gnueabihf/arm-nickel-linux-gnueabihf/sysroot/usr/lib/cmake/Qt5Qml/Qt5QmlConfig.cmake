...
set(Qt5Qml_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/QtQml/5.2.1"
        "${_qt5Qml_install_prefix}/include/QtQml/5.2.1/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    _populate_Qml_target_properties(RELEASE "libQt5Qml.so.5.2.1" "" )
