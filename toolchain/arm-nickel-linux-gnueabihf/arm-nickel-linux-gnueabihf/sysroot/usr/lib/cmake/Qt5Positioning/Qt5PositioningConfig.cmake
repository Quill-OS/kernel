...
set(Qt5Positioning_VERSION_STRING 5.2.0)
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.2.0"
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.2.0/QtPositioning"
    )
    ...
    set(_Qt5Positioning_MODULE_DEPENDENCIES "Qml;Core")
    ...
    foreach(_module_dep ${_Qt5Positioning_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.0 ${_Qt5Positioning_FIND_VERSION_EXACT}
    ...
    set(_Qt5Positioning_LIB_DEPENDENCIES "Qt5::Qml;Qt5::Core")
    ...
    _populate_Positioning_target_properties(RELEASE "libQt5Positioning.so.5.2.0" "" )
