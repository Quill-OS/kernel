...
set(Qt5Svg_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/QtSvg/5.2.1"
        "${_qt5Svg_install_prefix}/include/QtSvg/5.2.1/QtSvg"
    )
    ...
    set(_Qt5Svg_MODULE_DEPENDENCIES "Widgets;Network;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5Svg_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Svg_FIND_VERSION_EXACT}
    ...
    set(_Qt5Svg_LIB_DEPENDENCIES "Qt5::Widgets;Qt5::Network;Qt5::Gui;Qt5::Core")
    ...
    _populate_Svg_target_properties(RELEASE "libQt5Svg.so.5.2.1" "" )
