...
#ifdef CONFIG_BOOT_PARTITION_ACCESS
	  case 8: /* Fall through */
		part = simple_strtoul(argv[7], NULL, 10);
#endif
	  case 7: /* Fall through */
		numblks = simple_strtoul(argv[6], NULL, 10);
	default: /* at least 5 args */
		if (strcmp(argv[1], "read") == 0) {
			...
			printf("\nMMC read: dev # %d, block # %d, "
				"count %d, blks/transfer %d, partition # %d ... \n",
			       dev, blk, cnt, numblks, part);
#else
