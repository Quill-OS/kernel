...
#if 1 /* E_BOOK *//* Add PAD setting for SD1 2011/02/25 */
#define MX50_SD1_PAD_DAT	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#define MX50_SD1_PAD_CMD	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#define MX50_SD1_PAD_CLK	(PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#endif
...
#define MX50_SD3_PAD_CMD	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#define MX50_SD3_PAD_CLK	(PAD_CTL_DSE_HIGH)
#define MX50_SD4_PAD_CTRL	(PAD_CTL_DSE_LOW | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_SRE_FAST)
#define MX50_SD4_PAD_CTRL_CLK	(PAD_CTL_DSE_LOW | PAD_CTL_SRE_FAST)
#define MX50_SD4_PAD_CTRL_MED	(PAD_CTL_DSE_MED | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_SRE_FAST)
#define MX50_SD4_PAD_CTRL_MED_CLK	(PAD_CTL_DSE_MED | PAD_CTL_SRE_FAST)

#define MX50_UART_PAD_CTRL	(PAD_CTL_DSE_HIGH | PAD_CTL_PKE)
#define MX50_I2C_PAD_CTRL	(PAD_CTL_ODE | PAD_CTL_DSE_HIGH | \
					PAD_CTL_PUS_100K_UP | PAD_CTL_HYS)
/* 2011/07/07 FY11 : Modified Driver Strength of I2C2 (High -> Low). */
#define MX50_I2C2_PAD_CTRL	(PAD_CTL_ODE | PAD_CTL_DSE_LOW | \
					PAD_CTL_PUS_100K_UP | PAD_CTL_HYS)
...
#define PMIC_INT_PAD_CTRL                (PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define PMIC_OFF_IN_PAD_CTRL   (0)
#define PMIC_OFF_OUT_PAD_CTRL  (PAD_CTL_DSE_HIGH)

#define MX50_PAD_KEY_COL0__GPIO_4_0    IOMUX_PAD(0x2CC, 0x20, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#endif
#endif
//#define MX50_PAD_KEY_ROW0__GPIO_4_1	IOMUX_PAD(0x2D0, 0x24, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_KEY_ROW0__GPIO_4_1	IOMUX_PAD(0x2D0, 0x24, 1, 0x0, 0, PMIC_INT_PAD_CTRL)
#ifdef CONFIG_REGULATOR_TWL4030
...
#else
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_KEY_COL1__GPIO_4_2    IOMUX_PAD(0x2D4, 0x28, 1, 0x0, 0, 0x00)
#define MX50_PAD_KEY_ROW1__GPIO_4_3    IOMUX_PAD(0x2D8, 0x2C, 1, 0x0, 0, 0x00)
#endif
#endif
#define MX50_PAD_KEY_COL2__GPIO_4_4	IOMUX_PAD(0x2DC, 0x30, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_PWM1__GPIO_6_24	IOMUX_PAD(0x304, 0x58, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
#define MX50_PAD_PWM2__GPIO_6_25	IOMUX_PAD(0x308, 0x5C, 1, 0x0, 0, NO_PAD_CTRL)
#if 1 /* E_BOOK *//* LED for DEBUG 2010/12/27 */
#define MX50_PAD_PWM2__PWM2     IOMUX_PAD(0x308, 0x5C, 0, 0x0, 0, NO_PAD_CTRL)
#endif
...
#define MX50_PAD_WDOG__GPIO_6_28	IOMUX_PAD(0x314, 0x68, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_SSI_RXFS__GPIO_6_4	IOMUX_PAD(0x328, 0x7C, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_SSI_RXC__GPIO_6_5	IOMUX_PAD(0x32C, 0x80, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART1_TXD__GPIO_6_6	IOMUX_PAD(0x330, 0x84, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART1_RXD__GPIO_6_7	IOMUX_PAD(0x334, 0x88, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART1_CTS__GPIO_6_8	IOMUX_PAD(0x338, 0x8C, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART1_RTS__GPIO_6_9	IOMUX_PAD(0x33C, 0x90, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP|PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART2_TXD__GPIO_6_10	IOMUX_PAD(0x340, 0x94, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART2_RXD__GPIO_6_11	IOMUX_PAD(0x344, 0x98, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART2_CTS__GPIO_6_12	IOMUX_PAD(0x348, 0x9C, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_UART2_RTS__GPIO_6_13	IOMUX_PAD(0x34C, 0xA0, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_UART4_RXD__GPIO_6_17_PWR2     IOMUX_PAD(0x35C, 0xB0, 1, 0x0, 0, 0)
#else
#ifdef CONFIG_REGULATOR_WM831X
#define MX50_PAD_UART4_RXD__GPIO_6_17	IOMUX_PAD(0x35C, 0xB0, 1, 0x0, 0, \
                                                 PAD_CTL_PKE | PAD_CTL_PUE | \
...
#define MX50_PAD_ECSPI1_SCLK__GPIO_4_12	IOMUX_PAD(0x370, 0xC4, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
...
#else
#ifdef CONFIG_REGULATOR_WM831X
#define MX50_PAD_ECSPI1_MISO__GPIO_4_14	IOMUX_PAD(0x378, 0xCC, 1, 0x0, 0,  (PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN ))
#endif
#endif
/* HP detect */
#if 1 /* E_BOOK *//* bugfix pull up 2011/03/23 */
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, \
							PAD_CTL_PKE | PAD_CTL_PUE |PAD_CTL_PUS_100K_UP)
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15_POFF	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, \
							PAD_CTL_PUS_100K_UP)
#else
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, \
							PAD_CTL_PUS_100K_UP)
...
#define MX50_PAD_ECSPI2_SCLK__GPIO_4_16	IOMUX_PAD(0x380, 0xD4, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#ifdef CONFIG_REGULATOR_TWL4030
#define MX50_PAD_ECSPI2_MOSI__GPIO_4_17	IOMUX_PAD(0x384, 0xD8, 1, 0x0, 0, NO_PAD_CTRL)
#else
#ifdef CONFIG_REGULATOR_WM831X
#define MX50_PAD_ECSPI2_MOSI__GPIO_4_17	IOMUX_PAD(0x384, 0xD8, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#endif
#endif
#define MX50_PAD_ECSPI2_MISO__GPIO_4_18	IOMUX_PAD(0x388, 0xDC, 1, 0x0, 0, \
							PAD_CTL_PUS_100K_UP)
#define MX50_PAD_ECSPI2_SS0__GPIO_4_19	IOMUX_PAD(0x38C, 0xE0, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_SD2_CLK__GPIO_5_6	IOMUX_PAD(0x3A8, 0xFC, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_SD2_CMD__GPIO_5_7	IOMUX_PAD(0x3AC, 0x100, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_SD2_D0__GPIO_5_8	IOMUX_PAD(0x3B0, 0x104, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_SD2_D1__GPIO_5_9	IOMUX_PAD(0x3B4, 0x108, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_SD2_D2__GPIO_5_10	IOMUX_PAD(0x3B8, 0x10C, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#define MX50_PAD_SD2_D3__GPIO_5_11	IOMUX_PAD(0x3BC, 0x110, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
#ifdef CONFIG_REGULATOR_TWL4030
#define MX50_PAD_SD2_D4__GPIO_5_12	IOMUX_PAD(0x3C0, 0x114, 1, 0x0, 0, NO_PAD_CTRL)
#else
#ifdef CONFIG_REGULATOR_WM831X
#define MX50_PAD_SD2_D4__GPIO_5_12	IOMUX_PAD(0x3C0, 0x114, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#endif
#endif
...
#define MX50_PAD_SD2_D7__GPIO_5_15	IOMUX_PAD(0x3CC, 0x120, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
#ifdef CONFIG_REGULATOR_TWL4030
...
#else
#ifdef CONFIG_REGULATOR_WM831X
#define MX50_PAD_SD2_WP__GPIO_5_16	IOMUX_PAD(0x3D0, 0x124, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#endif
#endif
...
#define MX50_PAD_DISP_D0__GPIO_2_0	IOMUX_PAD(0x40C, 0x12C, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_DISP_D1__GPIO_2_1	IOMUX_PAD(0x410, 0x130, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_DISP_D2__GPIO_2_2	IOMUX_PAD(0x414, 0x134, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_DISP_D3__GPIO_2_3	IOMUX_PAD(0x418, 0x138, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
#define MX50_PAD_DISP_D4__GPIO_2_4	IOMUX_PAD(0x41C, 0x13C, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN|PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_DISP_WR__GPIO_2_16	IOMUX_PAD(0x42C, 0x14C, 1, 0x0, 0, PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_DISP_CS__GPIO_2_21	IOMUX_PAD(0x438, 0x158, 1, 0x0, 0, \
						  PAD_CTL_PKE|PAD_CTL_PUE| \
						  PAD_CTL_PUS_100K_UP| PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_DISP_RESET__GPIO_2_20	IOMUX_PAD(0x440, 0x160, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_SD3_D4__GPIO_5_24	IOMUX_PAD(0x45C, 0x17C, 1, 0x0, 0, 0 /* NO_PAD_CTRL */)
#ifdef CONFIG_REGULATOR_TWL4030
#define MX50_PAD_SD3_D5__GPIO_5_25	IOMUX_PAD(0x460, 0x180, 1, 0x0, 0, NO_PAD_CTRL)
#else
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_SD3_D5__GPIO_5_25	IOMUX_PAD(0x460, 0x180, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#endif
#endif
...
#define MX50_PAD_DISP_D8__GPIO_2_8	IOMUX_PAD(0x470, 0x190, 1, 0x0, 0, 0)
#define MX50_PAD_DISP_D9__GPIO_2_9	IOMUX_PAD(0x474, 0x194, 1, 0x0, 0, 0)
#define MX50_PAD_DISP_D10__GPIO_2_10	IOMUX_PAD(0x478, 0x198, 1, 0x0, 0, 0)
#define MX50_PAD_DISP_D11__GPIO_2_11	IOMUX_PAD(0x47C, 0x19C, 1, 0x0, 0, 0)
#define MX50_PAD_DISP_D12__GPIO_2_12	IOMUX_PAD(0x480, 0x1A0, 1, 0x0, 0, 0)
#define MX50_PAD_DISP_D13__GPIO_2_13	IOMUX_PAD(0x484, 0x1A4, 1, 0x0, 0, 0)
...
#if 1 /* E_BOOK *//* for EMI of EPD 2011/05/10 */
#define MX50_PAD_EPDC_D0__GPIO_3_0	IOMUX_PAD(0x54C, 0x1B0, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D1__GPIO_3_1	IOMUX_PAD(0x550, 0x1B4, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D2__GPIO_3_2	IOMUX_PAD(0x554, 0x1B8, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D3__GPIO_3_3	IOMUX_PAD(0x558, 0x1BC, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D4__GPIO_3_4	IOMUX_PAD(0x55C, 0x1C0, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D5__GPIO_3_5	IOMUX_PAD(0x560, 0x1C4, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D6__GPIO_3_6	IOMUX_PAD(0x564, 0x1C8, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D7__GPIO_3_7	IOMUX_PAD(0x568, 0x1CC, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_D8__GPIO_3_8	IOMUX_PAD(0x56C, 0x1D0, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#else
...
#define MX50_PAD_EPDC_D8__GPIO_3_8	IOMUX_PAD(0x56C, 0x1D0, 1, 0x0, 0,\
						  PAD_CTL_DSE_HIGH)
#endif
...
#if 1 /* E_BOOK *//* for EMI of EPD 2011/05/10 */
#define MX50_PAD_EPDC_GDCLK__GPIO_3_16	IOMUX_PAD(0x58C, 0x1F0, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_GDSP__GPIO_3_17	IOMUX_PAD(0x590, 0x1F4, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_GDOE__GPIO_3_18	IOMUX_PAD(0x594, 0x1F8, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#else
...
#endif
#ifdef CONFIG_REGULATOR_TWL4030
#define MX50_PAD_EPDC_GDRL__GPIO_3_19	IOMUX_PAD(0x598, 0x1FC, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#else
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_EPDC_GDRL__GPIO_3_19	IOMUX_PAD(0x598, 0x1FC, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#endif
#endif
#if 1 /* E_BOOK *//* for EMI of EPD 2011/05/10 */
#define MX50_PAD_EPDC_SDCLK__GPIO_3_20	IOMUX_PAD(0x59C, 0x200, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#else
#define MX50_PAD_EPDC_SDCLK__GPIO_3_20	IOMUX_PAD(0x59C, 0x200, 1, 0x0, 0, NO_PAD_CTRL)
#endif
/* 2011/05/26 FY11 : Supported TPS65181. (modified pad settings.) */
#define MX50_PAD_EPDC_SDOEZ__GPIO_3_21	IOMUX_PAD(0x5A0, 0x204, 1, 0x0, 0, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_DOWN | PAD_CTL_DSE_LOW )
// 2011/4/5 FY11 : Added pull-up for GPIO3-22 for WWAN SW for BB
//#define MX50_PAD_EPDC_SDOED__GPIO_3_22	IOMUX_PAD(0x5A4, 0x208, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDOED__GPIO_3_22	IOMUX_PAD(0x5A4, 0x208, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
#if 1 /* E_BOOK *//* Add for change IR Power to LDO10 2011/07/13 */
#define MX50_PAD_EPDC_SDOED__GPIO_3_22_LDO10	IOMUX_PAD(0x5A4, 0x208, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#endif
#if 1 /* E_BOOK *//* for EMI of EPD 2011/05/10 */
#define MX50_PAD_EPDC_SDOE__GPIO_3_23	IOMUX_PAD(0x5A8, 0x20C, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#define MX50_PAD_EPDC_SDLE__GPIO_3_24	IOMUX_PAD(0x5AC, 0x210, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#else
...
#else
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_EPDC_SDCLKN__GPIO_3_25	IOMUX_PAD(0x5B0, 0x214, 1, 0x0, 0, PMIC_OFF_OUT_PAD_CTRL)
#define MX50_PAD_EPDC_SDSHR__GPIO_3_26	IOMUX_PAD(0x5B4, 0x218, 1, 0x0, 0, PMIC_OFF_IN_PAD_CTRL)
#endif
#endif
#define MX50_PAD_EPDC_PWRCOM__GPIO_3_27	IOMUX_PAD(0x5B8, 0x21C, 1, 0x0, 0, NO_PAD_CTRL)
/* 2011/1/26 FY11 : Added pull-up for GPIO3-28 */
#define MX50_PAD_EPDC_PWRSTAT__GPIO_3_28	IOMUX_PAD(0x5BC, 0x220, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
#define MX50_PAD_EPDC_PWRCTRL0__GPIO_3_29	IOMUX_PAD(0x5C0, 0x224, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP |  PAD_CTL_DSE_HIGH)
#define MX50_PAD_EPDC_PWRCTRL1__GPIO_3_30	IOMUX_PAD(0x5C4, 0x228, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP |  PAD_CTL_DSE_HIGH)
...
#else
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_EPDC_BDR0__GPIO_4_23	IOMUX_PAD(0x5D8, 0x23C, 1, 0x0, 0, PMIC_OFF_IN_PAD_CTRL)
#define MX50_PAD_EPDC_BDR1__GPIO_4_24	IOMUX_PAD(0x5DC, 0x240, 1, 0x0, 0, (PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN ))
#endif
#endif
#if 1 /* E_BOOK *//* for EMI of EPD 2011/05/10 */
#define MX50_PAD_EPDC_SDCE0__GPIO_4_25	IOMUX_PAD(0x5E0, 0x244, 1, 0x0, 0, PAD_CTL_DSE_LOW)
#else
...
#define MX50_PAD_EIM_DA2__GPIO_1_2	IOMUX_PAD(0x600, 0x264, 1, 0x0, 0,  \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_EIM_DA5__GPIO_1_5	IOMUX_PAD(0x60C, 0x270, 1, 0x0, 0,  \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
#define MX50_PAD_EIM_DA6__GPIO_1_6	IOMUX_PAD(0x610, 0x274, 1, 0x0, 0,  \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_EIM_WAIT__GPIO_1_21	IOMUX_PAD(0x64C, 0x2B0, 1, 0x0, 0,  \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
/* SD4 */
#define MX50_PAD_DISP_D8__SD4_CMD IOMUX_PAD(0x470, 0x190, 4, 0x74c, 2, MX50_SD4_PAD_CTRL)
#define MX50_PAD_DISP_D9__SD4_CLK IOMUX_PAD(0x474, 0x194, 4, 0x748, 2, MX50_SD4_PAD_CTRL_CLK)
#define MX50_PAD_DISP_D10__SD4_D0 IOMUX_PAD(0x478, 0x198, 4, 0x750, 1, MX50_SD4_PAD_CTRL)
#define MX50_PAD_DISP_D11__SD4_D1 IOMUX_PAD(0x47c, 0x19c, 4, 0x754, 1, MX50_SD4_PAD_CTRL)
#define MX50_PAD_DISP_D12__SD4_D2 IOMUX_PAD(0x480, 0x1a0, 4, 0x758, 1, MX50_SD4_PAD_CTRL)
#define MX50_PAD_DISP_D13__SD4_D3 IOMUX_PAD(0x484, 0x1a4, 4, 0x75c, 1, MX50_SD4_PAD_CTRL)

#define MX50_PAD_DISP_D8__SD4_CMD_BB IOMUX_PAD(0x470, 0x190, 4, 0x74c, 2, MX50_SD4_PAD_CTRL_MED)
#define MX50_PAD_DISP_D9__SD4_CLK_BB IOMUX_PAD(0x474, 0x194, 4, 0x748, 2, MX50_SD4_PAD_CTRL_MED_CLK)
#define MX50_PAD_DISP_D10__SD4_D0_BB IOMUX_PAD(0x478, 0x198, 4, 0x750, 1, MX50_SD4_PAD_CTRL_MED)
#define MX50_PAD_DISP_D11__SD4_D1_BB IOMUX_PAD(0x47c, 0x19c, 4, 0x754, 1, MX50_SD4_PAD_CTRL_MED)
#define MX50_PAD_DISP_D12__SD4_D2_BB IOMUX_PAD(0x480, 0x1a0, 4, 0x758, 1, MX50_SD4_PAD_CTRL_MED)
#define MX50_PAD_DISP_D13__SD4_D3_BB IOMUX_PAD(0x484, 0x1a4, 4, 0x75c, 1, MX50_SD4_PAD_CTRL_MED)
...
/* Audio */
#define MX50_PAD_AUD_RESET	MX50_PAD_SSI_RXD__GPIO_6_3
#define MX50_PAD_AUD_MUTE	MX50_PAD_SD2_D6__GPIO_5_14
#define MX50_PAD_HP_DETECT	MX50_PAD_SD2_D7__GPIO_5_15
...
/* UART5 */
#define MX50_PAD_ECSPI2_MISO_UART5_TXD	IOMUX_PAD(0x388, 0xDC, 4, 0x0, 0, \
						PAD_CTL_DSE_HIGH)
#define MX50_PAD_ECSPI2_SS0_UART5_RXD	IOMUX_PAD(0x38C, 0xE0, 4, 0x7E4, 0x5, \
						  PAD_CTL_PKE | PAD_CTL_PUE | \
						  PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#endif
#endif
/* 2011/07/07 FY11 : Modified Driver Strength (High -> Low). */
...
#define MX50_PAD_CSPI_SS0__CSPI_SS0	IOMUX_PAD(0x36C, 0xC0, 0, 0x0, 0, \
						  PAD_CTL_DSE_HIGH)
#ifdef CONFIG_REGULATOR_WM831X 
#define MX50_PAD_CSPI_SCLK__CSPI_SCLK  IOMUX_PAD(0x360, 0xB4, 0, 0x0, 0, \
						 PAD_CTL_DSE_HIGH)
#endif
