...
/* Support FY11 */
extern struct platform_device ebk_button_device;
#endif /* E_BOOK */
#if 1	/* E_BOOK */
extern struct platform_device ar6000_pm_device;
extern struct platform_device wwan_ctrl_device;
#endif	/* E_BOOK */
#ifdef CONFIG_TOUCHSCREEN_SONYIR /* E_BOOK *//* 2011/1/12 */
extern struct platform_device sonyirtp_device[];
#endif
