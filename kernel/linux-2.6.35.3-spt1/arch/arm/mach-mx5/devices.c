...
/* Support FY11 */
struct platform_device ebk_button_device = {
	.name			= "gpio-keys",
	.id				= -1,
	.num_resources	= 0,
};
...
#if 1	/*E_BOOK*/
struct platform_device ar6000_pm_device = {
	.name = "wlan_ar6000_pm",
	.id = -1,
};
struct platform_device wwan_ctrl_device = {
	.name = "wwan_ctrl",
	.id = -1,
};
#endif	/*E_BOOK*/
...
/* SONY IR touchpanel device */
struct platform_device sonyirtp_device[] = {
  {
    .name = "sonyirtp",
    .id = 0,
    .num_resources  = 0,
