...
#ifdef CONFIG_HAS_WAKELOCK
static struct wake_lock fec_wake_lock;
#endif
...
#ifdef CONFIG_HAS_WAKELOCK
    wake_lock_timeout( &fec_wake_lock, 5*HZ );		//5sec
#endif
...
#ifdef CONFIG_HAS_WAKELOCK
	wake_lock_init( &fec_wake_lock, WAKE_LOCK_SUSPEND, "fec_restart");
#endif
...
{
#ifdef CONFIG_HAS_WAKELOCK
	wake_lock_destroy( &fec_wake_lock );
#endif
