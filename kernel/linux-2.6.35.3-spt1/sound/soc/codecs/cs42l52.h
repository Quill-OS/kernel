...
#define CHIP_REV_MASK					~(CHIP_ID_MASK)
...
#define IFACE_CTL1_WL_MASK				(0x03)
...
#define	CHANNEL_MIXER_NOSWAP			0x00
#define	CHANNEL_MIXER_MIX				0x01
#define	CHANNEL_MIXER_SWAP				0x03
#define	CHANNEL_MIXER_MASK				0x03
#define	CHANNEL_MIXER_PCMA_SHIFT		6
#define	CHANNEL_MIXER_PCMB_SHIFT		4
#define	CHANNEL_MIXER_ADCA_SHIFT		2
#define	CHANNEL_MIXER_ADCB_SHIFT		0
...
extern	struct	snd_soc_codec_device	soc_codec_cs42l52_device;
