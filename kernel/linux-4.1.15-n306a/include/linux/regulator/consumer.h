...
int __must_check regulator_setflags(struct regulator *regulator,unsigned long dwFlags);
...
static inline int regulator_setflags(struct regulator *regulator,unsigned long dwFlags)
{
	return 0;
}
