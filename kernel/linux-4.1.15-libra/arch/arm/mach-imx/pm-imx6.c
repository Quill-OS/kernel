...
static const u32 imx6sll_mmdc_lpddr3_offset[] __initconst = {
	0x01c, 0x85c, 0x800, 0x890,
	0x8b8, 0x81c, 0x820, 0x824, 0x828, 0x82c,
	0x830, 0x834, 0x838, 0x83c, 0x848, 0x850,
	0x8c0, 0x8b8, 0x004, 0x008,
	0x00c, 0x010, 0x038, 0x014,
	0x018, 0x01c, 0x02c, 0x030,
	0x040, 0x000, 0x020, 0x818,
...
static int __init imx6q_suspend_init(const struct imx6_pm_socdata *socdata)
{
	...
	if (cpu_is_imx6sll()) {
		if(pm_info->ddr_type == IMX_MMDC_DDR_TYPE_LPDDR3) {
			...
			pm_info->mmdc_val[18][1] = 0x20052;
			pm_info->mmdc_val[24][1] = 0x201718;
			pm_info->mmdc_val[25][1] = 0x8000;
			...
			pm_info->mmdc_val[24][1] = 0x201688;
			pm_info->mmdc_val[25][1] = 0x8000;
			pm_info->mmdc_val[32][1] = 0xa1310003;
		}
	}
