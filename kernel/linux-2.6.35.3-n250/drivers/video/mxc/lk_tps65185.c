...
#define TPS65185_EP3V3_OFFTICKS						400
...
static void _tps65185_pwrdwn(void)
{
	...
	if( TPS65185_MODE_ACTIVE==dwCurrentMode) {
		gdwSafeTick_To_TurnOFF_EP3V3 = jiffies+TPS65185_EP3V3_OFFTICKS;
		if(iIsWaitPwrOff) {
...
int tps65185_init(int iPort,int iEPDTimingType)
{
	...
	if( 34==gptHWCFG->m_val.bPCB||
			35==gptHWCFG->m_val.bPCB||
			33==gptHWCFG->m_val.bPCB||
			36==gptHWCFG->m_val.bPCB||
			40==gptHWCFG->m_val.bPCB||
			41==gptHWCFG->m_val.bPCB) 
	{
		// E606FXA/E606FXB/E60Q2X/E606GX ...
    // E60Q3X/E60Q5X
