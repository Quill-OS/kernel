...
const char gszNtxHwCfgVersion[]="v2.0"; // hw config tool version .
...
const char * gszTouchCtrlA[]={"No","TSC2004","Wacom Digitizer","Watop Digitizer","AUO-TP2","neonode",
		"PVI","ITE","neonode_v2","ektf2132","NC"};//touch controller .
...
const char * gszFrontLightA[]={"No","TABLE0","TABLE0+","TABLE0a","TABLE1+","TABLE2+","TABLE3+","TABLE4+","TABLE5+","TABLE6+","TABLE7+"};// Front Light .
 /*
...
const char * gszFrontLightLEDrvA[]={"SY7201","A8169","No"};//Front Light LED driver IC .
