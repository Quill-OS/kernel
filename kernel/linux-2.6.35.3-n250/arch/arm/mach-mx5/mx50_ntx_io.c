...
*/
	...
	if (gSleep_Mode_Suspend && (41==gptHWCFG->m_val.bPCB)) {
		mdelay (20);
	...
	if (gSleep_Mode_Suspend&&(35==gptHWCFG->m_val.bPCB || 34==gptHWCFG->m_val.bPCB || 41==gptHWCFG->m_val.bPCB )){// 
		// E606F0/E606F0B//E606G0 
		//
