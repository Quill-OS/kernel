...
#define BM_ANADIG_REG_1P1_ENABLE_CURRENT_LIMIT	0x4
#define BM_ANADIG_REG_2P5_ENABLE_WEAK_LINREG	0x40000
#define BM_ANADIG_REG_2P5_ENABLE_PULLDOWN	0x8
#define BM_ANADIG_REG_2P5_ENABLE_CURRENT_LIMIT	0x4
...
static void imx_anatop_enable_weak2p5(bool enable)
{
	...
	regmap_write(anatop, reg, BM_ANADIG_REG_2P5_ENABLE_WEAK_LINREG | BM_ANADIG_REG_2P5_ENABLE_CURRENT_LIMIT);
}
...
static inline void imx_anatop_enable_2p5_pulldown(bool enable)
{
	regmap_write(anatop, ANADIG_REG_2P5 + (enable ? REG_SET : REG_CLR),
		BM_ANADIG_REG_2P5_ENABLE_PULLDOWN | BM_ANADIG_REG_2P5_ENABLE_CURRENT_LIMIT);
}
...
static inline void imx_anatop_enable_2p5_current_limit(bool enable)
{
	regmap_write(anatop, ANADIG_REG_2P5 + (enable ? REG_SET : REG_CLR),
		BM_ANADIG_REG_2P5_ENABLE_CURRENT_LIMIT);
}

static inline void imx_anatop_enable_1p1_current_limit(bool enable)
{
	regmap_write(anatop, ANADIG_REG_1P1 + (enable ? REG_SET : REG_CLR),
		BM_ANADIG_REG_1P1_ENABLE_CURRENT_LIMIT);
}
...
void __init imx_anatop_init(void)
{
	...
	if (cpu_is_imx6ull())
		imx_anatop_enable_1p1_current_limit(true);
}
