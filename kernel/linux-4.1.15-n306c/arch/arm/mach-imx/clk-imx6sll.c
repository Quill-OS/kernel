...
static void __init imx6sll_clocks_init(struct device_node *ccm_node)
{
	...
	imx_clk_set_rate(clks[IMX6SLL_CLK_PLL2_PFD2], 400000000);
	//clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL2_PFD2]);
	imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 320000000);
	clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL3_PFD2]);
...
void imx6sll_epdc_pre_sel(int iSelFreq)
{
	if(400000000==iSelFreq) {
		// when PLL3_PFD2 setting 400MHz, it will be acctually set 392MHz
		imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 400000000);
		
		/* using CLK_PLL2_PFD2, whill happend epd no flush when suspend resume, 
		   because mmdc using this clock too. */
		//clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL2_PFD2]);
	}
	else if(440000000==iSelFreq) {
		imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 440000000);
		//clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL3_PFD2]);
	}
	else if(480000000==iSelFreq) {
		imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 480000000);
		//clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL3_PFD2]);
	}
	else if(528000000==iSelFreq) {
		imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 528000000);
		clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL2_BUS]);
	}
	else if(540000000==iSelFreq) {
		imx_clk_set_rate(clks[IMX6SLL_CLK_PLL3_PFD2], 540000000);
	}
	else {
		//clk_set_parent(clks[IMX6SLL_CLK_EPDC_PRE_SEL],clks[IMX6SLL_CLK_PLL3_PFD2]);
	}
