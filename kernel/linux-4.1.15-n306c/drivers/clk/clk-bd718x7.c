...
static int __init bd718x7_clk_init(void)
{
	return platform_driver_register(&bd71837_clk);
}
subsys_initcall_sync(bd718x7_clk_init);

static void __exit bd718x7_clk_exit(void)
{
	platform_driver_unregister(&bd71837_clk);
}
module_exit(bd718x7_clk_exit);
