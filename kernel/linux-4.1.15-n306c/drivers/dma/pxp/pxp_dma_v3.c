...
unsigned int save_lut_active0, save_lut_active1;
unsigned int save_lut_clean0,  save_lut_clean1;
...
static irqreturn_t pxp_irq(int irq, void *dev_id)
{
	...
	pxp_soft_reset(pxp);
	/*
	 * set lut state to 0 so that next time we get into
	 * pxp_set_lut, it will restore the lut control since it was
	 * lost due to pxp_soft_reset above
	 */
	pxp->lut_state = 0;
...
static void pxp_wfe_a_configure_v3p(struct pxps *pxp)
{
	...
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG0);
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG1);
	...
	__raw_writel(0x04090401, pxp->base + HW_PXP_WFE_B_STAGE1_MUX6);
	...
	__raw_writel(0x0C022A0F, pxp->base + HW_PXP_WFE_B_STAGE2_MUX8);
	__raw_writel(0x022A121C, pxp->base + HW_PXP_WFE_B_STAGE2_MUX9);
	...
	__raw_writel(0x00000013, pxp->base + HW_PXP_WFE_B_STAGE3_MUX5);
	__raw_writel(0x3b232d1d, pxp->base + HW_PXP_WFE_B_STAGE3_MUX6);
	__raw_writel(0x00000013, pxp->base + HW_PXP_WFE_B_STAGE3_MUX7);
	...
	__raw_writel(0x0000A000, pxp->base + HW_PXP_WFE_B_STG2_5X1_OUT3);
	__raw_writel(0x1F1F1F1F, pxp->base + HW_PXP_WFE_B_STG2_5X1_MASKS);
	...
	__raw_writel(0x1F1F1F1F, pxp->base + HW_PXP_WFE_B_STG3_F8X1_MASKS);
	...
	__raw_writel(0x0000A000, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT3_0);
...
{
	/*
	 * saved and restored later, since they'll be overrided in this func.
	 */
	save_lut_active0 = __raw_readl(pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT0_0);
	save_lut_active1 = __raw_readl(pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT0_1);
	save_lut_clean0  = __raw_readl(pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_0);
	save_lut_clean1  = __raw_readl(pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_1);
	...
	__raw_writel(
		...
		BF_PXP_WFB_ARRAY_PIXEL4_MASK_BUF_SEL(1) |
	...
	__raw_writel(
		...
		BF_PXP_WFB_ARRAY_PIXEL5_MASK_BUF_SEL(1) |
	...
	__raw_writel(
		...
		BF_PXP_WFB_ARRAY_PIXEL6_MASK_BUF_SEL(1) |
	...
	__raw_writel(
		...
		BF_PXP_WFB_ARRAY_PIXEL7_MASK_BUF_SEL(1) |
	...
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG0);
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG1);
	__raw_writel(0x000002AA, pxp->base + HW_PXP_WFB_ARRAY_REG2);
#else
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG0);
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG1);
	__raw_writel(0, pxp->base + HW_PXP_WFB_ARRAY_REG2);
#endif
	...
	__raw_writel(
		...
		BF_PXP_WFE_B_STORE_F_SHIFT_L_CH0_F_SHIFT_FLAG0(1)|
		BF_PXP_WFE_B_STORE_F_SHIFT_L_CH0_F_SHIFT_WIDTH1(4)|
		BF_PXP_WFE_B_STORE_F_SHIFT_L_CH0_F_SHIFT_FLAG1(1)|
	...
	__raw_writel(0x05070900, pxp->base + HW_PXP_WFE_B_STAGE1_MUX1);
	__raw_writel(0x00000103, pxp->base + HW_PXP_WFE_B_STAGE1_MUX2);
	__raw_writel(0x03000000, pxp->base + HW_PXP_WFE_B_STAGE1_MUX3);
	__raw_writel(0x07060504, pxp->base + HW_PXP_WFE_B_STAGE1_MUX4);
	...
	__raw_writel(0x0D101316, pxp->base + HW_PXP_WFE_B_STAGE2_MUX5);
	__raw_writel(0x0304050A, pxp->base + HW_PXP_WFE_B_STAGE2_MUX6);
	__raw_writel(0x00000102, pxp->base + HW_PXP_WFE_B_STAGE2_MUX7);
	...
	__raw_writel(0x020C010B, pxp->base + HW_PXP_WFE_B_STAGE2_MUX11);
	__raw_writel(0x0000000E, pxp->base + HW_PXP_WFE_B_STAGE2_MUX12);

	__raw_writel(0x09000C01, pxp->base + HW_PXP_WFE_B_STAGE3_MUX0);
	__raw_writel(0x002B2A0F, pxp->base + HW_PXP_WFE_B_STAGE3_MUX1);
	__raw_writel(0x09000C01, pxp->base + HW_PXP_WFE_B_STAGE3_MUX2);
	__raw_writel(0x002B2A0F, pxp->base + HW_PXP_WFE_B_STAGE3_MUX3);
	...
	__raw_writel(0x00000F0F, pxp->base + HW_PXP_WFE_B_STAGE1_5X8_MASKS_0);

	__raw_writel(0x00000000, pxp->base + HW_PXP_WFE_B_STG1_5X1_OUT0);
	__raw_writel(0x0000000F, pxp->base + HW_PXP_WFE_B_STG1_5X1_MASKS);

	__raw_writel(0x0000FFFE, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT0_0);
	...
	__raw_writel(0x0000FFFE, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_0);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_1);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_3);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_4);
	...
	__raw_writel(0x0000FFFE, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT2_0);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT2_1);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT2_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT2_3);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT2_4);
	...
	__raw_writel(0x0000FFFE, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT3_0);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT3_1);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT3_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT3_3);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT3_4);
	...
	__raw_writel(0x0000FFFE, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT4_0);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT4_1);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT4_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT4_3);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT4_4);
	...
	__raw_writel(0x00C000C0, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT0_1);
	__raw_writel(0x0000AAAA, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT0_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT0_3);
	...
	__raw_writel(0xFF00FF00, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT1_1);
	__raw_writel(0xFFFF0000, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT1_2);
	__raw_writel(0, pxp->base + HW_PXP_WFE_B_STG3_F8X1_OUT1_3);
...
static void pxp_wfe_b_process(struct pxps *pxp)
{
	...
	__raw_writel(
			...
			pxp->base + HW_PXP_WFE_B_SW_DATA_REGS);
#else
	/* Compute SIT and IAV From ASV */
	__raw_writel( ((5 - (proc_data->reagl_asv >> 2)) << 24)
		| ((comp_mask & 0x000000FF) << 16)
		| (4 << 8)
		| (5 - proc_data->reagl_sft),
		pxp->base + HW_PXP_WFE_B_SW_DATA_REGS);
	/* __raw_writel(
...
static int pxp_dispatch_thread(void *argv)
{
	...
	while (!kthread_should_stop()) {
		...
		if ((proc_data->engine_enable & PXP_ENABLE_WFE_B)) {
			__raw_writel(save_lut_active0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT0_0);
			__raw_writel(save_lut_active1, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT0_1);
			__raw_writel(save_lut_clean0, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_0);
			__raw_writel(save_lut_clean1, pxp->base + HW_PXP_WFE_B_STG1_8X1_OUT1_1);
		}
	}
