					...
					struct sy7636_platform_data *pdata)
{
	...
	if(of_property_read_u32(pmic_np,"vddh_ext",&sy7636->vddh_ext)) {
	...
	if(of_property_read_u32(pmic_np,"vpdd_len",&sy7636->vpdd_len)) {
	...
	if(of_property_read_u32(pmic_np,"vp_ext",&sy7636->vp_ext)) {
		sy7636->vp_ext=0xff;
	...
	if(of_property_read_u32(pmic_np,"vee_ext",&sy7636->vee_ext)) {
		sy7636->vee_ext=0xff;
	...
	if(of_property_read_u32(pmic_np,"VPDD",&sy7636->VPDD)) {
